...
/**
 * @namespace
 * @exports TargetNS as Core.Dev.Fred.HTMLCheck
 * @description
 *      This namespace contains all logic for the Fred module HTMLCHeck
 */
Core.Dev.Fred.HTMLCheck = (function (TargetNS) {
    ...
    function CheckBadPractice() {
        ...
        $("div").each(function(){
            ...
            if ($this.closest('.FredContainer, #NavigationContainer').length) {
                return;
            }
    ...
    TargetNS.CheckForStart = function () {
        if (jQuery) {
            $(document).ready(function(){
                Core.Dev.Fred.HTMLCheck.Run();
            });
        }
        else {
            setTimeout(function(){
                Core.Dev.Fred.HTMLCheck.CheckForStart();
            }, 250);
        }
    };
