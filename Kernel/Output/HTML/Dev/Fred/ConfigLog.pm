...
package Kernel::Output::HTML::Dev::Fred::ConfigLog;
...
Kernel::Output::HTML::Dev::Fred::ConfigLog - Dev::Fred backend module
...
creates the output of the config log
...
sub RenderOutput {
    ...
    $Param{ModuleRef}->{Output} = $LayoutObject->Output(
        TemplateFile => 'Dev/Fred/ConfigLog',
        Data         => {
            HTMLLines => $HTMLLines,
        },
    );
